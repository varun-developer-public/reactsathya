  ...
  return (
    <>
        ...
        <form onSubmit={handleSubmit} noValidate>
            ...
            {(formData.password.length<3|| formData.password.length >8) && <span style={{fontSize:`${fontSize}px`}}>invalid password</span>}
            {(formData.password.length<3|| formData.password.length >8) && <span style={{fontSize:`${fontSize}px`}}>invalid password</span>}
            {(formData.password.length<3|| formData.password.length >8) && <span style={{fontSize:`${fontSize}px`}}>invalid password</span>}
            {(formData.password.length<3|| formData.password.length >8) && <span style={{fontSize:`${fontSize}px`}}>invalid password</span>}
            {(formData.password.length<3|| formData.password.length >8) && <span style={{fontSize:`${fontSize}px`}}>invalid password</span>}
            ...
            {
                formData.password!=formData.confirmPassword && <span>PASSWORD NOT MATCHING</span>
            }
            <br /> <br />
